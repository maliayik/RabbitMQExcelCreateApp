...
namespace RabbitMqWeb.ExcelCreate.Services
{
    public class RabbitMQPublisher
    {
        ...
        public void Publish(CreateExcelMessage createExcelMessage)
        {
            ...
            channel.BasicPublish(exchange: RabbitMQClientService.ExchangeName, routingKey: RabbitMQClientService.RoutingKeyName, basicProperties: properties, body: bodyByte);
        }
    }
}
